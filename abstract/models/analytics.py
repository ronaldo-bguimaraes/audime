...
class GastoMensal(Base):
    ...
    total_gasto = sa.Column(sa.Numeric(12, 2), nullable=False, default=0, server_default="0")
    qtd_transacoes = sa.Column(sa.Integer, nullable=False, default=0, server_default="0")
    qtd_notas = sa.Column(sa.Integer, nullable=False, default=0, server_default="0")
...
class GastoCategoria(Base):
    ...
    mes_ano = sa.Column(sa.Date, nullable=False)
    total_gasto = sa.Column(sa.Numeric(12, 2), nullable=False, default=0, server_default="0")
    qtd_itens = sa.Column(sa.Integer, nullable=False, default=0, server_default="0")
    atualizado_em = pg_timestampz()
...
class ItemNotaAnalytics(Base):
    ...
    id_nota_analytics = sa.Column(sa.BigInteger, sa.ForeignKey("analytics.nota_analytics.id_nota_analytics"), nullable=False)
